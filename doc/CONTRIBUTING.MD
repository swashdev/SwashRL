Spelunk! Guidelines for Contributors
====================================

Last updated 2018-07-24 03:55 EST
...
the [Readme](../readme.txt) and [the doc folder](../doc).  In the doc folder
you'll find [a to-do list](../doc/to-do.txt)
