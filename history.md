...
| **0.031 Christmas Update** | 2019-12-21 23:02 CST | This was a special release made to protest a decision by the Microsoft VSCode theme to remove an icon of a Santa hat from VSCode Insider because of a complaint they had received claiming that Santa hats are "equivalent to a swastika."  This update added greetings which the player would receive on certain holidays, namely New Year's, Christmas, October, and Hanami.  Additionally, the player receives a "festive hat" if they start the game during the month of December.  This release also fixed an error where items would be allowed in inappropriate item slots. |
