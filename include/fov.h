 ...
 * visible by default unless they specifically block vision.  Otherwise, all
 * tiles in this octant will be set to FALSE (in order to cast shadows for the
 * recursive call) */
/* this function calculates what lines need to be scanned for visibility and
 * then calls scan_row or scan_col appropriately */
